    ...
    >
      <View style={styles.headerCard}>
        ...
        <View style={styles.selfBadge}>
          <Text style={styles.selfBadgeText}>{user?.username ? `@${user.username}` : '...'}</Text>
        </View>
      </View>
...
const styles = StyleSheet.create({
  ...
  headerTitle: { color: '#f8fafc', fontSize: 24, fontWeight: '800', marginBottom: 4 },
  statusBar: {
  ...
  selfBadgeText: { color: '#cbd5e1', fontSize: 12, fontWeight: '700' },
  listContent: { paddingHorizontal: 12, paddingBottom: 8, paddingTop: 6 },
  empty: { color: '#475569', textAlign: 'center', marginTop: 80, fontSize: 14 },
  ...
  bubbleMe: { backgroundColor: '#2563eb', borderBottomRightRadius: 6 },
  bubbleOther: {
    backgroundColor: '#111827', borderBottomLeftRadius: 6,
  ...
  typing: { color: '#64748b', fontSize: 12, paddingHorizontal: 18, paddingVertical: 6, fontStyle: 'italic' },
  inputRow: {
    flexDirection: 'row', alignItems: 'flex-end', paddingHorizontal: 12, paddingTop: 10, paddingBottom: 14,
    backgroundColor: '#0f172a', borderTopWidth: 1, borderColor: '#1e293b',
  },
  input: {
    flex: 1, backgroundColor: '#020617', color: '#e2e8f0', borderRadius: 22,
    paddingHorizontal: 14, paddingVertical: 10, fontSize: 15, borderWidth: 1,
    borderColor: '#334155', maxHeight: 100, marginRight: 8,
  },
  sendBtn: { backgroundColor: '#2563eb', borderRadius: 18, paddingHorizontal: 18, paddingVertical: 12 },
