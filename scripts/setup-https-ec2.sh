...
CRON_CMD="docker run --rm -v /etc/letsencrypt:/etc/letsencrypt -v $INFRA_DIR/certbot/www:/var/www/certbot certbot/certbot renew --webroot -w /var/www/certbot --quiet && docker compose -f $INFRA_DIR/docker-compose.ec2.yml -f $INFRA_DIR/docker-compose.ec2.https.yml restart nginx"
